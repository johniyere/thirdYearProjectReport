...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{single-point-on-map.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{path-between-points.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{map-contours.png}
